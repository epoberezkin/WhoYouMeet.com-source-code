 ...
 *
 *---------------------------------------------------------------
 * File /application/controllers/twtest.php
 * 
 * Test pages for twconnect.php library
 *---------------------------------------------------------------
 * 
 */
...
class Twtest extends CI_Controller {
	...
	public function api(){
		echo '<pre>';
		print_r(json_decode(file_get_contents('https://api.twitter.com/1/users/show.json?id=25169653')));
		echo '</pre>';
	}

}

/* End of file /application/controllers/twtest.php */